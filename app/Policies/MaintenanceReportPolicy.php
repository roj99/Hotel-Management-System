...
class MaintenanceReportPolicy
{
     ...
     */
    public function restore(User $user, MaintenanceReport $maintenanceReport): bool
    {
        return true;
    }
     ...
     */
    public function forceDelete(User $user, MaintenanceReport $maintenanceReport): bool
    {
        return true;
    }
}
